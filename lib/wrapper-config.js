...
function buildAuthHeader(env = process.env) {
  ...
  throw new Error(
    'FDA_DATA_API_KEY or FDA_DATA_AUTH_HEADER is required to use the FDA Data MCP wrapper. Get a free API key at https://www.regdatalab.com/signup (300 free credits/month).'
  );
}
